...
<body>
	...
	<h3> &nbsp&nbsp&nbsp&nbsp&nbsp신고자 정보 등록 </h3>
	...
	신고일시: <input type = "datetime-local" name = "applicant_date" min = "2010-01-01" required/> <br>
	
	<hr>
	<button type = "submit" formaction = "/PolicePHP/Applicant_Insert_result.php"> 등록하기</button>
	</form>
</body>
</html>