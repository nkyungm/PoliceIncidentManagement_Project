...
<body>
	...
	<h3> &nbsp&nbsp&nbsp&nbsp&nbsp가해자 정보 등록 </h3>
	...
	주소: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type = "text" name = "address" placeholder = "북구 123로 12 상세주소"/> <br>
	...
	<hr>
	<button type = "submit" formaction = "/PolicePHP/Suspect_Insert_result.php"> 등록하기</button>
</form> 
