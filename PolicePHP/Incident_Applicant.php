...
<body>
	...
	<h3> &nbsp&nbsp&nbsp&nbsp&nbsp신고자 정보 상세 </h3>
...
<?php
    ...
    echo "<hr>";
    if ($check){
        echo "<a href = '/PolicePHP/Applicant_update.php?applicant_id=$applicant_id&role=$role&teamId=$teamId'><button>수정하기</button></a> ";
    }
