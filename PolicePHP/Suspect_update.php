<?php
    ...
    $sql = "CALL searchSuspect('".$suspect_id."')";
...
<h3> &nbsp&nbsp&nbsp&nbsp&nbsp가해자 정보 수정 </h3>
...
<form method = "post">
    ...
    ?>
    <button type = "submit" formaction = "/PolicePHP/Suspect_update_result.php?suspect_id=<?php echo $suspect_id; ?>>"> 수정완료</button>
